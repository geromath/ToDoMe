...
from root.gravatars.gravatar_tags import calculate_gravatar_hash, get_gravatar_url, GRAVATAR_DEFAULT_SIZE, \
    ...
    has_gravatar, get_gravatar_profile_url
...
class TestGravatarHelperMethods(TestCase):
    ...
    def test_gravatar_url(self):
        ...
        email_upper = "USERNAME@stud.ntnu.no"
        email_strip = "   USERNAME@stud.ntnu.no  "
    ...
    def test_has_gravatar(self):
        ...
        """
        bad_email = 'username@example.com'
        good_email = 'username@automattic.com'
